...
public class MoranIndexApi extends Jooby{
  {
        ...
        path("/api/moran2018", () -> {
          ...
          get(req -> {
            ...
            double VI_norm = Math.abs(v_num / v_den - moranEI * moranEI);

            double seI_norm = Math.sqrt(VI_norm);

            double z_norm = (moran - moranEI) / seI_norm ;
            //double z_norm = (moran - moranEI);
            ...
            System.out.println("E(I) = " + moranEI);
            System.out.println("Z-Index = " + z_norm);
            System.out.println("P-Value = " + p_norm);




            return new double[]{moran,z_norm};
